import { ArrowRight, ExternalLink, GitBranch, GitBranchPlus, GitCommit, GitCompare } from "lucide-react";
    ...
    <section id="projects" className="py-24 px-4 relative">
      <div className="container mx-auto max-w-5xl">
        ...
        <p className="text-center text-muted-foreground mb-12 max-w-2xl mx-auto">
          Here are some of my featured projects that I did on my free time and school projects as well.
        </p>
        ...
        <div className="text-center mt-12">
          <a 
            ...
            href="https://github.com/BarisJomarie"
            target="__blank"
          >
